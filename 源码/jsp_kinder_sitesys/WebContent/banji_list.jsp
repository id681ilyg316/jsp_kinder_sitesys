...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="banji_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="banji_list.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
