...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
 ...
 <% 
    ...
    String url = "jiaoxuexinxi_list2.jsp?1=1"; 
    String sql =  "select * from jiaoxuexinxi where fabujiaoshi='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("fabujiaoshi")=="" ||request.getParameter("fabujiaoshi")==null ){}else{sql=sql+" and fabujiaoshi like '%"+request.getParameter("fabujiaoshi")+"%'";}
 ...
 <td><%=map.get("fabujiaoshi") %></td>
    ...
    <td width="60" align="center"><a href="jiaoxuexinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="jiaoxuexinxi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="jiaoxuexinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
