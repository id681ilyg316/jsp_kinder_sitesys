...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" action="">
   搜索:  职工编号：<input name="zhigongbianhao" type="text" id="zhigongbianhao" style='border:solid 1px #000000; color:#666666' size="12" />  姓名：<input name="xingming" type="text" id="xingming" style='border:solid 1px #000000; color:#666666' size="12" />
...
//txixixngdy
    ...
    String url = "jiaoshi_list2.jsp?1=1"; 
    String sql =  "select * from jiaoshi where 1=1";
	
if(request.getParameter("zhigongbianhao")=="" ||request.getParameter("zhigongbianhao")==null ){}else{sql=sql+" and zhigongbianhao like '%"+request.getParameter("zhigongbianhao")+"%'";}
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="jiaoshi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
