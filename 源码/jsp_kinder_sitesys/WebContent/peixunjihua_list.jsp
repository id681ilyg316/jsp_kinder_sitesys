...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="peixunjihua_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="peixunjihua_list.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <a href="peixunjihua_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
