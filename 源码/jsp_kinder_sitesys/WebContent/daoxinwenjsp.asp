...
<%
connstr="DRIVER={SQL Server};Server=.;UID=sa;PWD=sa123456;DATABASE=jspmxtybjwzwylb0534;"
...
<body>
<%
sql="select top 15  * from allgonggao where title like '%公告%' or leibie like '%公告%' order by newid()"
